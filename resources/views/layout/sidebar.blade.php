...
<li class="nav-item {{ active_class(['supplier*','item*']) }}">
  <a class="nav-link" data-toggle="collapse" href="#tables-menu"
     aria-expanded="{{ is_active_route(['supplier*','item*']) }}"
  ...
  <div class="collapse {{ show_class(['supplier*','item*']) }}" id="tables-menu">
    <ul class="nav flex-column sub-menu">
